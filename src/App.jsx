    ...
    <div className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-8 md:px-10 lg:px-12">
          <nav className="mb-14 flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-5 py-4 backdrop-blur">
            ...
            <a
              ...
              className="rounded-2xl bg-fuchsia-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-fuchsia-500/30 transition hover:scale-[1.02]"
            >
              WhatsApp Us
            </a>
          </nav>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              <div className="mb-4 inline-flex rounded-full border border-sky-400/30 bg-sky-400/10 px-4 py-2 text-sm text-sky-200">
            ...
            <div className="grid gap-5">
              <div className="rounded-[28px] border border-white/10 bg-gradient-to-br from-slate-900 to-slate-800 p-6 shadow-2xl shadow-black/30">
      ...
      <section id="services" className="mx-auto max-w-7xl px-6 py-20 md:px-10 lg:px-12">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-[32px] border border-sky-400/20 bg-sky-400/10 p-8">
          ...
          <div className="rounded-[32px] border border-fuchsia-400/20 bg-fuchsia-400/10 p-8">
            <div className="mb-5 flex items-center gap-3">
      ...
      <section className="border-t border-white/10 bg-white/5">
        <div className="mx-auto max-w-7xl px-6 py-16 md:px-10 lg:px-12">
          <div className="grid gap-8 lg:grid-cols-[1.3fr_0.7fr] lg:items-center">
            ...
            <div className="rounded-[32px] border border-white/10 bg-slate-950/40 p-6 text-center">
